...
function NetZeroPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await DataFetch<NewsItem[], NetZeroPayload>(
                    SERVER_LINK,
                    {
                        signal: "datafetch",
                        datapage: "net-zero"
                ...
                console.error("Lỗi tải trang Net Zero:", error);
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="thoisu-container">
            <div className="section-header">
                <h2 className="section-title">Net Zero</h2>
                <div className="sub-nav">
                    <a href="#">Tin tức & Xu hướng </a>
                    <a href="#">Chuyển đổi xanh</a>
                    <a href="#">Sống xanh</a>
                    <a href="#">Cẩm nang</a>
                </div>
            </div>
